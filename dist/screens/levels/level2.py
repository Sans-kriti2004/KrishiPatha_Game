...
class Level2:
    def __init__(self, screen, set_screen_callback):
        ...
        quiz_bg_path = os.path.join(self.assets, "quiz_bg2.png")
        ...
        # Flood quiz questions
        self.questions = [
            {"q": "What is the single most critical immediate action a farmer should take after floodwaters begin to recede from a crop field?",
             "options": [
                 "Begin heavy tillage to mix silt deposits into the original topsoil.",
                 "Apply a high-nitrogen fertilizer to compensate for nutrient leaching.",
                 "Drain standing water from the field as quickly as possible.",
                 "Test the soil for microbial contamination before it fully dries."
             ],
             "answer": "Drain standing water from the field as quickly as possible."
            },
            {"q": "According to food safety protocols, what is the required action for the edible portion of crops (like leafy greens) that have been in direct contact with floodwaters?",
             "options": [
                 "Segregate the contaminated area and discard the crops intended for human consumption.",
                 "Wash the crop thoroughly with a high-concentration chlorine solution and market immediately.",
                 "Harvest the crop immediately and sell it to a low-risk processing facility.",
                 "Wait one week, then harvest and divert the entire crop for use as animal feed."
             ],
             "answer": "Segregate the contaminated area and discard the crops intended for human consumption."
            },
            {"q": "What is the best way for a livestock farmer to ensure immediate animal safety in a known flood-prone pasture?",
             "options": [
                 "Leave all gates open so animals can escape to neighboring properties.",
                 "Stockpile several weeks of feed and water in low-lying barns for easy access.",
                 "Construct permanent, elevated soil mounds (refuge mounds) in the pasture.",
                 "Administer preventative vaccines against waterborne diseases when the flood warning is issued."
             ],
             "answer": "Construct permanent, elevated soil mounds (refuge mounds) in the pasture."
            },
            {"q": "Why should agricultural chemicals be moved to high ground when a flood is expected?",
             "options": [
                 "To prevent the contamination of floodwaters by hazardous materials like fuel, oil, and pesticides.",
                 "To prevent the heavy machinery from being swept away by swift-moving flood currents.",
                 "To ensure the equipment is easily accessible for post-flood cleanup operations.",
                 "To avoid having to clean silt and mud from the complex undercarriage of the machinery."
             ],
             "answer": "To prevent the contamination of floodwaters by hazardous materials like fuel, oil, and pesticides."
            },
            {"q": "What is the recommended post-flood strategy for a field where the topsoil was severely eroded, and beneficial fungi were lost (known as 'flooded soil syndrome')?",
             "options": [
                 "Deep plow the entire area to expose fresh, nutrient-rich subsoil.",
                 "Avoid planting for a full year and allow the land to remain fallow.",
                 "Plant cover crops (like rye or legumes) to reduce erosion and stimulate microbial activity.",
                 "Apply chemical fungicides immediately to sterilize the soil surface."
             ],
             "answer": "Plant cover crops (like rye or legumes) to reduce erosion and stimulate microbial activity."
            },
        ]
